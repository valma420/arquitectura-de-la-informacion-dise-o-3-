...
export const pieces: Piece[] = [
  /* -------------------------------- Siglo XVIII ------------------- */
  d('casaca-bordada', 'Casaca bordada', 1740, 'c. 1700–1750', 'siglo-xviii', '/images/prendas/1700s.png', 'cutout', {
    themeIds: ['el-cuerpo-vestido', 'el-color'],
    material: 'Seda · hilo metálico',
    technique: 'Bordado a mano',
    inv: 'GAL.1920.551',
  }),
  d('robe-francaise-1730', 'Robe à la française', 1730, 'c. 1730', 'siglo-xviii', '/images/prendas/1730.png', 'cutout', {
    material: 'Brocado de seda',
    inv: 'GAL.1965.17',
  }),
  d('robe-francaise-1760', 'Robe à la française', 1760, 'c. 1760', 'siglo-xviii', '/images/prendas/1760.png', 'cutout', {
    themeIds: ['la-silueta', 'el-color'],
    material: 'Seda de Lyon',
    inv: 'GAL.1959.7',
  }),
  d('robe-polonaise', 'Robe à la polonaise', 1775, 'c. 1775', 'siglo-xviii', '/images/prendas/1775.png', 'cutout', {
    inv: 'GAL.1960.24',
  }),
  d('vestido-corte', 'Vestido de corte', 1775, 'c. 1775', 'siglo-xviii', '/images/prendas/1775-b.png', 'cutout', {
    material: 'Seda brochada · encaje',
    inv: 'GAL.1978.78',
  }),
  d('caraco-falda', 'Caraco y falda', 1785, 'c. 1775–1790', 'siglo-xviii', '/images/prendas/1775-90.png', 'cutout', {
    inv: 'GAL.1980.179',
  }),
  d('robe-anglaise', "Robe à l'anglaise", 1780, 'c. 1780', 'siglo-xviii', '/images/prendas/1780.png', 'cutout', {
    inv: 'GAL.1980.185',
  }),
  d('redingote', 'Redingote', 1785, 'c. 1785', 'siglo-xviii', '/images/prendas/1785.png', 'cutout', {
    themeIds: ['el-cuerpo-vestido'],
    inv: 'GAL.1982.91',
  }),
  d('chaleco-courtois', 'Chaleco', 1790, 'entre 1790 y 1795', 'siglo-xviii', '/images/prendas/1790.png', 'cutout', {
  ...
  d('vestido-gasa-1790', 'Vestido de gasa', 1790, 'c. 1790', 'siglo-xviii', '/images/prendas/1790-b.png', 'cutout', {
    material: 'Gasa de algodón',
    inv: 'GAL.1994.234',
  }),

  /* -------------------------------- Siglo XIX --------------------- */
  d('vestido-imperio', 'Vestido Imperio', 1815, 'c. 1815', 'siglo-xix', '/images/prendas/1815.png', 'cutout', {
    inv: 'GAL.1969.33',
  }),
  d('vestido-romantico', 'Vestido de día', 1830, 'c. 1830', 'siglo-xix', '/images/prendas/1830.png', 'cutout', {
    themeIds: ['la-silueta', 'el-color'],
    inv: 'GAL.1985.63',
  }),
  d('vestido-crinolina', 'Vestido de crinolina', 1850, 'c. 1850', 'siglo-xix', '/images/prendas/1850.png', 'cutout', {
    description:
      'La crinolina llevó la amplitud de la falda a su máximo histórico: una estructura de aros que sostenía metros de tela.',
    inv: 'GAL.1985.322',
  }),
  d('vestido-polison', 'Vestido de polisón', 1870, 'c. 1870', 'siglo-xix', '/images/prendas/1870.png', 'cutout', {
    inv: 'GAL.2000.81',
  }),

  /* -------------------------------- Belle Époque ------------------ */
  d('vestido-recepcion', 'Vestido de recepción', 1900, 'c. 1900', 'belle-epoque', '/images/prendas/1900.png', 'cutout', {
    description:
      'La silueta en S de la Belle Époque: pecho proyectado, talle mínimo y cola. París era la capital indiscutida de la moda.',
    inv: 'GAL.1978.47',
  }),
  d('conjunto-paseo', 'Conjunto de paseo', 1905, 'c. 1905', 'belle-epoque', '/images/prendas/photo-05.jpg', 'photo', {
  ...
  /* -------------------------------- Années Folles ----------------- */
  d('vestido-charleston', 'Vestido Charleston', 1925, 'c. 1925', 'annees-folles', '/images/prendas/1925.png', 'cutout', {
  ...
  d('vestido-noche-1930', 'Vestido de noche', 1930, 'c. 1930', 'annees-folles', '/images/prendas/1930.png', 'cutout', {
  ...
  /* -------------------------------- Fin era Dior ------------------ */
  d('vestido-trapecio', 'Vestido trapecio', 1959, '1959', 'fin-era-dior', '/images/prendas/1959.png', 'cutout', {
  ...
  /* -------------------------------- Prêt-à-porter ----------------- */
  d('conjunto-1968', 'Conjunto prêt-à-porter', 1968, '1968', 'pret-a-porter', '/images/prendas/1968.png', 'cutout', {
    themeIds: ['el-cuerpo-vestido'],
  ...
  /* -------------------------------- Posmoderno -------------------- */
  d('vestido-alaia-1983', 'Vestido de punto', 1983, '1983', 'posmoderno', '/images/prendas/1983.png', 'cutout', {
  ...
  d('vestido-alaia-escultura', 'Vestido escultura', 1986, 'c. 1986', 'posmoderno', '/images/prendas/alaia.png', 'cutout', {
    designer: 'Azzedine Alaïa',
    themeIds: ['el-cuerpo-vestido', 'los-disenadores'],
    description:
  ...
  d('vestido-gala-1995', 'Vestido de gala', 1995, '1995', 'posmoderno', '/images/prendas/1995.png', 'cutout', {
    section: 'Alta costura',
    inv: 'GAL.2004.23',
  }),
  d('vestido-2011', 'Vestido contemporáneo', 2011, '2011', 'posmoderno', '/images/prendas/2011.png', 'cutout', {
